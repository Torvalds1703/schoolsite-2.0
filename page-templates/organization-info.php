    ...
    <div class="accordeon__item accordeon-item accordeon-item--noicon">
      <div class="accordeon-item__card">
        ...
        <p class="accordeon-item__subheading">
          <span class="accordeon-item__amount">Ссылок: 6</span>
        ...
        <div class="accordeon-item__collapsing">
          <ul>
            ...
            <li>
              <a target="_blank" href="<?php echo site_url( 
                "/wp-content/uploads/2025/10/reestrovaya-vypiska.pdf" 
                ); ?>">Выписка из государственной информационной системы «Реестр организаций, осуществляющих образовательную деятельность по имеющим государственную аккредитацию образовательным программам» на «07» октября 2025 г
              </a>
            </li>
            <li>
              <a target="_blank" href="<?php echo site_url( 
                "/wp-content/uploads/2025/10/reestrovaya-vypiska-2.pdf" 
                ); ?>">Выписка из реестра лицензий по состоянию на «07» октября 2025г.
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="accordeon-item__card">
        ...
        <div class="accordeon-item__collapsing">
          <ul>
            ...
            <a target="_blank" href="<?php echo site_url(
              "/wp-content/uploads/2025/10/reestrovaya-vypiska.pdf"
            ); ?>">Выписка из государственной информационной системы «Реестр организаций, осуществляющих образовательную деятельность по имеющим государственную аккредитацию образовательным программам» на «07» октября 2025 г</a>
            </li>
          </ul>
        </div>
    </div>
